...
class dalUserManagement {
	public static function InsertNewUser(db $db, $UserName, $UserPassword, $FirstName, $LastName, $Address, $phone, $role) {
        $query = "call Insert_New_User('".$UserName."','".$UserPassword."','".$FirstName."','".$LastName."','".$Address."','".$phone."','".$role."')";
        return $db->insertQeury($query);
    }
